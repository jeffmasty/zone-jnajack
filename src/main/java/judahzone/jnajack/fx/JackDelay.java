 ...
 * @author Jeff Masty
 */
public class JackDelay implements JNATime, RTEffect {
    ...
    public JackDelay(float maxdelay) {
    ...
    public void set(int idx, int value) {
        ...
        else if (idx == Settings.Type.ordinal() && value < JNATime.TYPE.length)
            type = JNATime.TYPE[value];
    ...
    public void sync(float unit) {
        float msec = 0.001f * (unit + unit * JNATime.indexOf(type));
        setDelayTime(2 * msec);
    }
