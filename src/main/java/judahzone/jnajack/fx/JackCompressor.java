...
/*
 ...
 You should have received a copy of the GNU General Public License (version2)  along with this program; if not, write to the Free Software Foundation,
...
public class JackCompressor implements RTEffect {
    ...
    @Override public String getName() {
        return JackCompressor. class.getSimpleName();
    }
