...
public class JackBiquad {
	...
	public JackBiquad(FilterType type, float frequency) { // Hi/Lo pass
		this(type, frequency, 2, 16f);
	}

	public JackBiquad(int hz) {
		this(hz, 1.5f);
	}

	public JackBiquad(int hz, float bandwidth) { // EQ
		this(FilterType.Peaking, hz, bandwidth, 0f);
	}

	public JackBiquad(FilterType type, float frequency, float bandwidth, float gain) {
